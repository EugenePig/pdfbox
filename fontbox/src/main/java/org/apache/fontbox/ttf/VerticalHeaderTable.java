...
public class VerticalHeaderTable extends TTFTable
{
    ...
    /**
     * @param advanceHeightMaxValue The advanceHeightMax to set.
     */
    public void setAdvanceHeightMax(int advanceHeightMaxValue)
    {
        this.advanceHeightMax = advanceHeightMaxValue;
    }
    /**
    ...
    /**
     * @param minTopSideBearingValue The minTopSideBearing to set.
     */
    public void setMinTopSideBearing(short minTopSideBearingValue)
    {
        this.minTopSideBearing = minTopSideBearingValue;
    }
    /**
    ...
    /**
     * @param minBottomSideBearingValue The minBottomSideBearing to set.
     */
    public void setMinBottomSideBearing(short minBottomSideBearingValue)
    {
        this.minBottomSideBearing = minBottomSideBearingValue;
    }
    /**
    ...
    /**
     * @param caretOffsetValue The caretOffset to set.
     */
    public void setCaretOffset(short caretOffsetValue)
    {
        this.caretOffset = caretOffsetValue;
    }    
    /**
    ...
    /**
     * @param maxExtentValue The yMaxExtent to set.
     */
    public void setYMaxExtent(short maxExtentValue)
    {
        yMaxExtent = maxExtentValue;
    }
}
